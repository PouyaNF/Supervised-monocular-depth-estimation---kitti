...
def setNanToZero(input, target):
    ...
    _input = input.clone() # Returns a copy of input . This function is differentiable, so gradients will flow back from the result of this operation to input .
...
class AverageMeter(object):
    def __init__(self):
        self.reset()  # when we create object it resets
